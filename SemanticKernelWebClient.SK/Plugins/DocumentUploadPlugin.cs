...
namespace SemanticKernelWebClient.SK.Plugins
{
    public class DocumentUploadPlugin
    {
        private SemanticKernelWebClientDBContext _context;
        private ConfigurationValues _configValues;

        public DocumentUploadPlugin(SemanticKernelWebClientDBContext context, ConfigurationValues configValues)
        {
            _context = context;
